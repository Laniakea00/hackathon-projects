...
если в протоколе написано "A39.0", выводи "A39.0", а не "A39". Никогда не обрезай подкод.
- Если в одном протоколе перечислено несколько кодов (например, "B27.0, B27.1, B27.9"), \
выбери тот, который точнее соответствует клинической картине пациента.
